...
class Result(Generic[TElem]):
    ...
    first: Any = ...
    second: Any = ...
    def __init__(self, edit_op: EditOp, *target: TElem) -> Any: ...
...
class Tags:
    tags: Any = ...
    def __init__(self, tags: str) -> Any: ...
...
class SequenceMatcher(Generic[TElem]):
    ...
    seq_b: Any = ...
    autojunk: Any = ...
    def __init__(self, isjunk: Optional[Callable[[TElem], bool]]=..., a: Sequence[TElem]=..., b: Sequence[TElem]=..., autojunk: bool=...) -> Any: ...
